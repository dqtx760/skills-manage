...
description: >
  AI-powered writing assistant for social media content creation, offering six
  structured writing methods: conversational writing, outline-based writing,
  completion-style writing, inspiration generation, revision optimization, and
  material integration. Use when the user needs help with social media posts,
  articles, overcoming writer's block, structuring ideas, improving quality, or
  integrating multiple sources into coherent content.
---
